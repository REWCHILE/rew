    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'faqs' => [
                    ['q' => '¿Tiene algún costo mensual o pago por cada boleta emitida?', 'a' => 'Cero. A diferencia de otras plataformas o servicios con cobro recurrente por documento, esta es una licencia vitalicia (Lifetime) de pago único de $350.000 CLP. Pagas una sola vez y el plugin es tuyo para siempre.'],
                    ['q' => '¿Qué necesito para la instalación y puesta en marcha?', 'a' => 'Solo necesitas las credenciales o token API de tu cuenta Bsale y acceso a tu WordPress. El paquete incluye soporte y acompañamiento técnico directo de Álvaro Valenzuela Valdés para configurar bodegas, probar el entorno y verificar la emisión DTE.'],
                    ['q' => '¿Cómo evita las sobreventas si tengo tiendas físicas?', 'a' => 'Si vendes un producto en tu sucursal física a través del punto de venta Bsale, el stock se actualiza en tiempo real en WooCommerce, impidiendo que clientes online compren mercadería ya vendida.'],
                ],
                'is_featured' => true,
                'version' => '2.0.0',
        ...
        $projects = [
            ...
            14 => [
                ...
                'gallery' => [
                    0 => '/images/portfolio/betsturf.webp',
                ],
                'results' => [
                    0 => 'Procesamiento y modelado de datos de carreras hípicas con algoritmos de Machine Learning',
                    1 => 'Arquitectura backend sólida, segura y escalable construida sobre Laravel',
                    2 => 'Panel analítico interactivo con visualización de datos y probabilidades en tiempo real',
                    3 => 'Plataforma internacional con usuarios activos en múltiples hipódromos del mundo',
                ],
                'is_featured' => true,
                'order' => 1,
            ...
            15 => [
                ...
                'gallery' => [
                    0 => '/images/portfolio/high_contrast_detailing.webp',
                ],
                'results' => [
                    0 => 'Arquitectura moderna, escalable y segura desarrollada sobre Laravel',
                    1 => 'Diseño visual premium orientado a clientes del segmento automotriz de lujo',
                    2 => 'Posicionamiento orgánico destacado en Chicureo, Colina y sector oriente',
                    3 => 'Canal directo de cotización y agendamiento de turnos vía WhatsApp',
                ],
                'is_featured' => true,
                'order' => 2,
            ...
            16 => [
                ...
                'gallery' => [
                    0 => '/images/portfolio/gasfiter_certificado.webp',
                ],
                'results' => [
                    0 => 'Score de 100/100 perfecto en Google PageSpeed Insights (Mobile & Desktop)',
                    1 => 'Tiempo de carga ultra rápido inferior a 400ms en redes móviles',
                    2 => 'Top rankings locales en Google para servicios de gasfitería en Santiago',
                    3 => 'Alta conversión de visitas a llamadas directas y chats de WhatsApp',
                ],
                'is_featured' => true,
                'order' => 3,
            ...
            17 => [
                ...
                'gallery' => [
                    0 => '/images/portfolio/instalgas_chile.webp',
                ],
                'results' => [
                    0 => '100/100 en Google PageSpeed Insights en dispositivos móviles y de escritorio',
                    1 => 'First Contentful Paint (FCP) inferior a 350ms y 0 Cumulative Layout Shift',
                    2 => 'Estructura optimizada para campañas de Google Ads y llamadas de urgencia',
                    3 => 'Aumento de más del 300% en cotizaciones y llamadas directas',
                ],
                'is_featured' => true,
                'order' => 4,
