...
class PortfolioController extends Controller
{
    ...
    {
        $mustSync = PortfolioProject::where('slug', 'funktographer')->doesntExist()
            || PortfolioProject::where('slug', 'prodoral-chile')->doesntExist();
